...
if (isset($_POST["Delete"])) {
        $db->query("DELETE FROM referral WHERE Title = '{$fa}'");
        header('location: admin.php');
}

$Diag=$db->query("SELECT * FROM referral WHERE Title = '{$fa}'");

if (isset($_POST["Back"])) {
        $db->query("UPDATE referral SET Title = '{$_POST['DD']}' WHERE Id = '{$Diag[0]['Id']}'");
        header('location: admin.php');  
				...
				<form method="POST">
					<div class="col-md-12">		
							...
							<div class="col-md-2 text-center">
								<p class="myCardd"><strong>Специалист:</strong> </p>							
							</div>
