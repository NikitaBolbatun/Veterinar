...
if (isset($_POST["Delete"])) {
        $db->query("DELETE FROM service WHERE Title = '{$fa}'");
        header('location: admin.php');
}

$Diag=$db->query("SELECT * FROM service WHERE Title = '{$fa}'");

if (isset($_POST["Back"])) {
        $db->query("UPDATE service SET Title = '{$_POST['DD']}' WHERE Id = '{$Diag[0]['Id']}'");
        $db->query("UPDATE service SET Cost = '{$_POST['text']}' WHERE Id = '{$Diag[0]['Id']}'");
        header('location: admin.php');  
				...
				<form method="POST">
					<div class="col-md-12">		
							...
							<div class="col-md-4 text-center">
								...
								<div class="col-md-2 text-center">
								<p class="myCardd downPriem"><strong>Стоимость:</strong> </p>							
							</div>
							<div class="col-md-4 text-center">
							<input type="text" name="text" placeholder="<?=$Diag[0]['Cost']; ?>">	
